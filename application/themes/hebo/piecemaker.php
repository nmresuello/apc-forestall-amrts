...
<Piecemaker>
  <Contents>
  	<Image Source="'.$_GET['path'].'/img/slider/gado-jalandoni.jpg" Title="Advocacy"></Image>
	  <Image Source="'.$_GET['path'].'/img/slider/jess-jalandoni.jpg" Title="ERM"></Image>
	  <Image Source="'.$_GET['path'].'/img/slider/gado-jess-1.jpg" Title="Hapag-asa"></Image>
    <Image Source="'.$_GET['path'].'/img/slider/gado-jess-2.jpg" Title="Hapag-asa"></Image>
    <Image Source="'.$_GET['path'].'/img/slider/gado-jess-3.jpg" Title="Hapag-asa"></Image>
  </Contents>
  <Settings ImageWidth="1100" ImageHeight="435" LoaderColor="0x333333" InnerSideColor="0x222222" SideShadowAlpha="0" DropShadowAlpha="0" DropShadowDistance="0" DropShadowScale="0" DropShadowBlurX="0" DropShadowBlurY="4" MenuDistanceX="20" MenuDistanceY="50" MenuColor1="0x999999" MenuColor2="0x333333" MenuColor3="0xFFFFFF" ControlSize="50" ControlDistance="20" ControlColor1="0x222222" ControlColor2="0xFFFFFF" ControlAlpha="0.8" ControlAlphaOver="0.95" ControlsX="500" ControlsY="215" ControlsAlign="center" TooltipHeight="30" TooltipColor="0x222222" TooltipTextY="5" TooltipTextStyle="P-Italic" TooltipTextColor="0xFFFFFF" TooltipMarginLeft="5" TooltipMarginRight="5" TooltipTextSharpness="50" TooltipTextThickness="-100" InfoWidth="400" InfoBackground="0xFFFFFF" InfoBackgroundAlpha="0.95" InfoMargin="15" InfoSharpness="0" InfoThickness="0" Autoplay="10" FieldOfView="45"></Settings>
  <Transitions>
